...
-- user_id: 2 has the most number of comments (6), however there are 3 other users that also have the same amount of comments, user_id: 3, 7, and 11. But if you set the limit to just 1, it would return user_id: 2.
...
LIMIT 1;
-- Post_id 1 through 50 all have 5 comments, however if you set the limit to 1, post_id 1 has the most comments.
...
LIMIT 1;
-- user_id: 1 has the most number of people following them, 7, however user_id: 2, 5, and 6 also have 7 people following them. But if you set the limit to just 1, it would return user_id: 1.
